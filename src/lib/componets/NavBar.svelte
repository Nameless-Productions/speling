...
<nav class="fixed -mt-2 flex w-full items-center space-x-5 border-b-2 bg-slate-900 p-2">
	...
	{#if !user}
		<a
			href={resolve('/login')}
			class="rounded-full bg-white p-1 text-lg text-slate-800 duration-200 hover:bg-gray-400"
			>Log in</a
		>
	{:else}
